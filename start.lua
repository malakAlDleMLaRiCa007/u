...
Sudos = {sudoid,1573309498,1573309498}
Sudo_Id = 1573309498
function Bot(msg)  
local idbot = false  
...
- تم انشاء الصانع مقدم من قناة ( @LaRiCaTeam ) مجاناً 
...
• تاريخ الانشاء :* ( `2022/7/7` )
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : @filesLaRiCa .
- قناتنا دعم السورس : @LaRiCaTeam .*
